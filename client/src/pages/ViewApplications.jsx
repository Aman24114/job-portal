    ...
    <tbody>
        {viewApplicationsPageData.map((applicant,index)=>(
           ...
           <td className='py-2 px-4 border-b'>
            <a href="#" target="_blank" className="bg-lue-50 text-blue-400 px-3 py-1 rounded inline-flex gap-2 items-center  ">Resume <img src={assets.resume_download_icon} alt="" /></a>
           </td>
