        ...
        {isSearched && (searchFilter.title !== "" || searchFilter.location !== "") && (
          <>
            ...
            <div className='mb-4 text-gray-600'>
              {searchFilter.title && (
                <span className='inline-flex items-center bg-blue-50 border border-blue-200 py-1.5 px-2'>
                  {searchFilter.title}
                  <img onClick={() => setSearchFilter(prev => ({ ...prev, title: "" }))} className='cursor-pointer ml-2' src={assets.cross_icon} alt="" />
                </span>
              )}
              {searchFilter.location && (
                <span className='ml-2 inline-flex items-center bg-red-50 border border-red-200 py-1.5 px-2'>
                  {searchFilter.location}
                  <img onClick={() => setSearchFilter(prev => ({ ...prev, location: "" }))} className='cursor-pointer ml-2' src={assets.cross_icon} alt="" />
                </span>
              )}
            </div>
          </>
